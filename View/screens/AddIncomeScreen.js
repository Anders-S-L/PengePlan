...
export function AddIncomeScreen({ onSave, onCancel }) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await AsyncStorage.setItem("income", JSON.stringify(next));
            onSave(entry);
        } finally {
            setIsSaving(false);
        }
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>Tilfoej indtaegt</Text>
            ...
            <View style={styles.footer}>
                <Pressable
                    ...
                    disabled={isSaving}
                >
                    <Text style={styles.primaryButtonText}>Tilfoej indtaegt</Text>
                </Pressable>
                <Pressable
                    accessibilityRole="button"
                    onPress={onCancel}
